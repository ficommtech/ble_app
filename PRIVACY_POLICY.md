Ficomm: Privacy policy
Welcome to the ficomm app for Android!

This is an open source Android app developed by ficomm. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
